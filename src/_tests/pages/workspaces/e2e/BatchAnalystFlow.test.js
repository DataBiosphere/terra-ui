...
describe('Google', () => {
  ...
  it('create a workspace and launch a batch analysis (workflow)', async () => {
    ...
    // return Promise.resolve();
      ...
      // TODO: * upload "small set" of data (& confirm)
      // TODO: * create a method config for a method in agora (set up the method)
        // (Create a method config for a method in Agora which is a single “word count” task which uses a real file (gs://) as input and writes results to a real file (gs://))
      // TODO: * Configure inputs
      // TODO: * Launch a pipeline via config
      // TODO: * wait for successful completion (should we?)
      // TODO: * "Check binding of results in entity model"
