import { getAllAppTypes, isToolAnApp, tools } from 'src/components/notebook-utils'

describe('getAllAppTypes and isToolAnApp', () => {
  it('getAllAppTypes includes tools with a defined appType', () => {
    expect(getAllAppTypes.sort).toBe([tools.galaxy.appType, tools.cromwell.appType].sort)
  })
