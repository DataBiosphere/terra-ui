...
1. [Libraries and Technologies](#libraries-and-technologies)
1. [Our Coding Philosophies](#our-coding-philosophies)
1. [Coding Style (...and how it ties in to our philophies)](#coding-style)
...
## CircleCI
# Our Coding Philosophies
0. Write simple, easy to understand code
  ps
0. Write simple, easy to understand code
...
0. Don't be afraid to upset the status quo
  ...
  * React Hooks
  * Daily releases
0. Always ask why / what is the problem we are addressing?
...
0. If something is hard to understand or see something that can be done better, do it!
...
0. Keep the development environment simple and easy to use, providing clear error messages
0. Write tests for the users
  * Have the tests focus on how a user will use the application rather than unit tests
0. Use the least powerful abstraction to complete the job
