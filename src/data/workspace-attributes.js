export const displayLibraryAttributes = [
  ...
  { key: 'library:dataCategory', title: 'Data Category' },
  { key: 'library:datatype', title: 'Experimental Strategy' },
  { key: 'library:dataUseRestriction', title: 'Data Use Limitation' },
  { key: 'library:indication', title: 'Cohort Phenotype/Indication' },
  { key: 'library:datasetName', title: 'Cohort Name' },
  { key: 'library:datasetVersion', title: 'Dataset Version' },
  { key: 'library:datasetDescription', title: 'Cohort Description' },
  { key: 'library:datasetOwner', title: 'Dataset Owner' },
  { key: 'library:datasetCustodian', title: 'Dataset Custodian' },
  { key: 'library:datasetDepositor', title: 'Dataset Depositor' },
  { key: 'library:contactEmail', title: 'Contact Email' },
  { key: 'library:institute', title: 'Research Institute' },
  { key: 'library:primaryDiseaseSite', title: 'Primary Disease Site' },
  { key: 'library:projectName', title: 'Project Name' },
  { key: 'library:reference', title: 'Genome Reference Version' },
  { key: 'library:dataFileFormats', title: 'Data File Formats' },
  { key: 'library:technology', title: 'Profiling Instrument Type' },
  { key: 'library:profilingProtocol', title: 'Profiling Protocol' },
  { key: 'library:coverage', title: 'Depth of Sequencing Coverage (Average)' },
  { key: 'library:studyDesign', title: 'Study Design' },
  { key: 'library:cellType', title: 'Cell Type' },
  { key: 'library:ethnicity', title: 'Reported Ethnicity' },
