...
import { makeReferenceAlias } from 'src/data/reference-data/reference-metadata';
...
export const ReferenceDataDeleter = ({ onSuccess, onDismiss, namespace, name, referenceDataType }) => {
  ...
  return h(
    ...
    [
      div(['Are you sure you want to delete the ', b([makeReferenceAlias(referenceDataType)]), ' reference data?']),
