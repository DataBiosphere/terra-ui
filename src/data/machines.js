...
// Notable restrictions as per https://cloud.google.com/compute/docs/gpus#restrictions as of June 9, 2021
// Excluding NVIDIA® K80 GPU type, since we cannot guarantee VMs won't run on Intel Skylake or later CPU platforms
// GPUs are currently only supported with general-purpose N1 or accelerator-optimized A2 machine types.
export const gpuTypes = [
  { name: 'nvidia-t4', cpu: 1, memory: 3.75, price: 0.0475, preemptiblePrice: 0.0100 },
  { name: 'n1-standard-2', cpu: 2, memory: 7.50, price: 0.0950, preemptiblePrice: 0.0200 },
  { name: 'n1-standard-4', cpu: 4, memory: 15, price: 0.1900, preemptiblePrice: 0.0400 },
  { name: 'n1-standard-8', cpu: 8, memory: 30, price: 0.3800, preemptiblePrice: 0.0800 },
  { name: 'n1-standard-16', cpu: 16, memory: 60, price: 0.7600, preemptiblePrice: 0.1600 },
