...
describe('test gettingHierarchyMap', () => {
  ...
  test('fetching hierarchy map of id 400', () => {
    ...
    hierarchyMap.set(100, [dummyGetConceptForId(400), dummyGetConceptForId(408)]);
    expect(getHierarchyMap(400)).toStrictEqual(hierarchyMap);
  });
  test('fetching hierarchy map of id 401', () => {
    const hierarchyMap = new Map<number, Concept[]>();
    hierarchyMap.set(100, [dummyGetConceptForId(400), dummyGetConceptForId(408)]);
    hierarchyMap.set(400, [dummyGetConceptForId(401)]);
  ...
  test('fetching hierarchy map of id 402', () => {
    ...
    hierarchyMap.set(100, [dummyGetConceptForId(400), dummyGetConceptForId(408)]);
    hierarchyMap.set(400, [dummyGetConceptForId(401)]);
    hierarchyMap.set(401, [dummyGetConceptForId(402), dummyGetConceptForId(403), dummyGetConceptForId(404)]);
  ...
  test('fetching hierarchy map of id 407', () => {
    ...
    hierarchyMap.set(400, [dummyGetConceptForId(401)]);
    hierarchyMap.set(401, [dummyGetConceptForId(402), dummyGetConceptForId(403), dummyGetConceptForId(404)]);
    hierarchyMap.set(402, [dummyGetConceptForId(407)]);
