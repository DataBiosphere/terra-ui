...
export default props => <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cloud-upload"
  className="svg-inline--fa fa-cloud-upload fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
