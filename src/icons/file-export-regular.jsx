...
export default props => <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="file-export"
  className="svg-inline--fa fa-file-export fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg"
