...
describe('SubmissionHistory page', () => {
  ...
  beforeEach(() => isFeaturePreviewEnabled.mockImplementation((_id) => false));
...
describe('SubmissionHistory subtab', () => {
  const headerPosition = {
    Actions: 0,
    Submission: 1,
    Status: 2,
  ...
  beforeEach(() => isFeaturePreviewEnabled.mockImplementation((id) => id === ENABLE_WORKFLOWS_SUBMISSION_UX_REVAMP));
