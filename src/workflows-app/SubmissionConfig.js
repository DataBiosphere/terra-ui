...
export const SubmissionConfig = wrapWorkflowsPage({ name: 'SubmissionConfig' })(
  (
    {
      methodId,
      name,
          ...
          displayLaunchModal &&
            h(
              ...
              [
                ...
                div({ style: { lineHeight: 2.0, marginTop: '1.5rem' } }, [
                  div([
                    h(TextCell, ['This will launch ', span({ style: { fontWeight: 'bold' } }, [_.keys(selectedRecords).length]), ' workflow(s).']),
                  ]),
