...
describe('Environments Component', () => {
  describe('Runtimes - ', () => {
    ...
    it('Renders page correctly with multiple runtimes and workspaces', async () => {
      ...
      expect(getTextContentForColumn(firstRuntimeRow, 0)).toBe(`${defaultAzureWorkspace.workspace.namespace}`);
      expect(getTextContentForColumn(firstRuntimeRow, 1)).toBe(`${defaultAzureWorkspace.workspace.name}`);
      ...
      expect(getTextContentForColumn(tableRows[2], 0)).toBe(`${defaultGoogleWorkspace.workspace.namespace}`);
      expect(getTextContentForColumn(tableRows[2], 1)).toBe(`${defaultGoogleWorkspace.workspace.name}`);
  ...
  describe('Apps - ', () => {
    ...
    it('Renders page correctly with multiple apps and workspaces', async () => {
      ...
      expect(getTextContentForColumn(thirdAppRow, 0)).toBe(defaultAzureWorkspace.workspace.namespace);
      expect(getTextContentForColumn(thirdAppRow, 1)).toBe(defaultAzureWorkspace.workspace.name);
      ...
      expect(getTextContentForColumn(fourthAppRow, 0)).toBe(azureWorkspace2.workspace.namespace);
      expect(getTextContentForColumn(fourthAppRow, 1)).toBe(azureWorkspace2.workspace.name);
  ...
  describe('Disks - ', () => {
    ...
    it('Renders page correctly with multiple workspaces/disks', async () => {
      ...
      expect(getTextContentForColumn(thirdDiskRow, 0)).toBe(defaultAzureWorkspace.workspace.namespace);
      expect(getTextContentForColumn(thirdDiskRow, 1)).toBe(defaultAzureWorkspace.workspace.name);
      ...
      expect(getTextContentForColumn(fourthDiskRow, 0)).toBe(azureWorkspace2.workspace.namespace);
      expect(getTextContentForColumn(fourthDiskRow, 1)).toBe(azureWorkspace2.workspace.name);
