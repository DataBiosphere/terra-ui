...
import { pdTypeFromDiskType } from 'src/libs/ajax/leonardo/providers/LeoDiskProvider';
...
export const GalaxyModalBase = withDisplayName('GalaxyModal')(
  ({
    ...
    const renderActionButton = () => {
      ...
      return Utils.switchCase(
        ...
        [
          'paused',
          () => {
            return h(Fragment, [deleteButton, resumeButton]);
          },
        ],
        [
          Utils.DEFAULT,
                      ...
                      h(Fragment, [
                        h(
                          ButtonOutline,
                          {
                            ...
                            tooltip: 'Cloud Compute must be resumed first.',
    ...
    const renderPersistentDiskSize = (disabled) =>
      div([
        h(IdContainer, [
          (id) =>
            h(Fragment, [
        ...
        div({ style: { lineHeight: '1.5rem' } }, [
          h(Fragment, [
            ...
            h(
              ...
              [
                p(['Deletes your persistent disk, which will also ', span({ style: { fontWeight: 600 } }, ['delete all files on the disk.'])]),
