...
// shared by the per-file Download buttons and the file array's show more/fewer toggle
...
// the per-file download buttons only handle one file at a time, so point users at the bulk options
