...
const getUserAddedButton = () => expectNotNull(screen.queryByLabelText('I have added terra-billing as a billing account user (requires reauthentication)'))
...
describe('AddTerraAsBillingAccountUserStep', () => {
  ...
  describe('The initial state when the step is active', () => {
    beforeEach(() => {
      render(h(AddTerraAsBillingAccountUserStep, {
        isActive: true,
    ...
    it('has both radio button options shown, with neither selected ', () => {
      ...
      const terraUserAddedButton = screen.queryByLabelText('I have added terra-billing as a billing account user (requires reauthentication)')
    ...
    it('shows the correct instructions to the user', () => {
      const instructions = textMatcher('Add terra-billing@terra.bio as a Billing Account User to your billing account.')
  ...
  describe('the behavior of the buttons', () => {
    ...
    const renderStep = (overrides: Partial<AddTerraAsBillingAccountUserStepProps>) => render(
