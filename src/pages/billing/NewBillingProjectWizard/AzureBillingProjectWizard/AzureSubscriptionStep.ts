...
import { customSpinnerOverlay, Link } from 'src/components/common';
        ...
        h(
          ...
          [
            h(ManagedApplicationSelect, {
              ...
              onChange: (managedApp) => props.onManagedAppSelected(managedApp),
              allManagedApps: managedApps.status === 'Ready' ? managedApps.state : [],
            }),
          ]
        ),
      ]),
