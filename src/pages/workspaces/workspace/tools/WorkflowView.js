...
const WorkflowView = _.flow(
  ...
  render() {
    const { isFreshData, savedConfig, selectedEntity, launching, activeTab } = this.state
  ...
  renderSummary() {
    ...
    const {
      ...
      saving, saved, copying, deleting, activeTab, errors, firecloudRoot, dockstoreRoot, synopsis, documentation
    } = this.state
