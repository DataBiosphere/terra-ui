...
//TODO:------- Move edits into tool-utils -------
//TODO: Change to gcpTools
export const tools = {
  ...
  Jupyter: {
    ...
    ext: ['ipynb'],
    isNotebook: true,
    imageIds: ['terra-jupyter-bioconductor', 'terra-jupyter-bioconductor_legacy', 'terra-jupyter-hail',
      'terra-jupyter-python', 'terra-jupyter-gatk', 'Pegasus', 'terra-jupyter-gatk_legacy'],
  ...
  JupyterLab: { label: 'JupyterLab', isNotebook: true, ext: ['ipynb'], isAzureCompatible: true, isLaunchUnsupported: false, defaultExt: 'ipynb' }
}
...
export const toolExtensionDisplay = {
  ...
  JupyterLab: [{ label: 'IPython Notebook (.ipynb)', value: 'ipynb' }]
}
...
)([tools.Jupyter, tools.RStudio, tools.Galaxy, tools.Cromwell, tools.JupyterLab])
