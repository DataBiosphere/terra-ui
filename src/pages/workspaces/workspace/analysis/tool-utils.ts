...
export const isToolLabelAnApp = (x: ToolLabel): x is AppToolLabel => x in appToolLabelTypes
...
export const getToolForImage = (image: string) => _.find(tool => _.includes(image, tool.imageIds), runtimeTools)?.label
...
export const getAppType = (label: AppToolLabel): string => appTools[label].appType
