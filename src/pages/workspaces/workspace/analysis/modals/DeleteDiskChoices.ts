...
export const DeleteDiskChoices = ({
  ...
  const getMountDirectoryDisplay = (toolLabel) =>
    toolLabel
      ...
      : `${mountPoints.Jupyter} for Jupyter environments and ${mountPoints.RStudio} for RStudio environments`;
    ...
    h(
      ...
      [
        p([
          ...
          code({ style: { fontWeight: 600 } }, [getMountDirectoryDisplay(toolLabel)]),
        ...
        p({ style: { marginBottom: 0 } }, [
          ...
          span({ style: { fontWeight: 600 } }, [`${persistentDiskCostDisplay} per month.`]),
        ]),
      ]
    ),
    h(
