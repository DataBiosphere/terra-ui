...
import {
  AnalysisProviderDependencies,
  analysisProviderDependencies
} from 'src/dependencies/analysis/analysis-provider-resolver'
...
export interface AnalysisExportStateDeps {
  analysisProviders: Pick<AnalysisProviderDependencies, 'AnalysisProvider'>
}

export type LoadedAnalysisNames = LoadedState<string[], unknown>

export interface AnalysisExportStateArgs {
...
export type AnalysesExportStateHook = (args: AnalysisExportStateArgs) => AnalysisExportState

export type ComposableAnalysisExportStateHook = Composable<
    AnalysisExportStateDeps,
    AnalysesExportStateHook
    >
...
export const useAnalysisExportState: ComposableAnalysisExportStateHook = {
  compose: (deps: AnalysisExportStateDeps) => {
  ...
  resolve: () => useAnalysisExportState.compose({
    analysisProviders: analysisProviderDependencies.get()
  })
}
