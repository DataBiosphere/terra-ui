...
export const isResourceDeletable = (resourceType, resource: App | PersistentDisk | Runtime) => _.includes(_.lowerCase(resource?.status), Utils.switchCase(resourceType,
...
export const isComputePausable = (computeType, compute: App | Runtime) => _.includes(_.lowerCase(compute?.status), Utils.switchCase(computeType,
