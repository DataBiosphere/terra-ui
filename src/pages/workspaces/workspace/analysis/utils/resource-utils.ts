...
export const isResourceDeletable = (resourceType, resource: AppType | PersistentDisk | Runtime) => _.includes(_.lowerCase(resource?.status), Utils.switchCase(resourceType,
...
export const isComputePausable = (computeType, compute: AppType | Runtime) => _.includes(_.lowerCase(compute?.status), Utils.switchCase(computeType,
