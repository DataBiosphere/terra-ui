...
describe("isSettingsSupported - Non-Prod", () => {
  ...
  test.each(testCases)(
    "should return $expectedResult for $toolLabel app in $cloudProvider workspace based on access level and workspace creation date",
    ({ toolLabel, cloudProvider, accessLevel, createdDate, expectedResult }) => {
