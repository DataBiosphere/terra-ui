...
describe("doesWorkspaceSupportCromwellApp - Prod", () => {
  ...
  it("return true when Azure workspace has been created after Workflows Public Preview", () => {
    expect(
      doesWorkspaceSupportCromwellApp("2023-03-28T20:28:01.998494Z", cloudProviderTypes.AZURE, appToolLabels.CROMWELL)
    ).toBe(true);
  });

  it("return false when Azure workspace has been created before Workflows Public Preview", () => {
    expect(
      doesWorkspaceSupportCromwellApp("2023-03-19T20:28:01.998494Z", cloudProviderTypes.AZURE, appToolLabels.CROMWELL)
    ).toBe(false);
  });

  it("return true for GCP workspaces irrespective of creation date", () => {
    expect(
      doesWorkspaceSupportCromwellApp("2023-03-19T20:28:01.998494Z", cloudProviderTypes.GCP, appToolLabels.CROMWELL)
    ).toBe(true);
  });

  it("return true for any other app irrespective of creation date", () => {
    expect(
      doesWorkspaceSupportCromwellApp("2023-03-19T20:28:01.998494Z", cloudProviderTypes.GCP, appToolLabels.GALAXY)
    ).toBe(true);
  });
});
//
