...
import { allAppTypes, appTools, Galaxy, isAppToolLabel, toolLabels } from 'src/pages/workspaces/workspace/analysis/tool-utils'


describe('getAllAppTypes and isToolAnApp', () => {
  it('getAllAppTypes includes tools with a defined appType', () => {
    expect(allAppTypes.sort).toBe([Galaxy.appType, appTools.Cromwell.appType].sort)
  })
