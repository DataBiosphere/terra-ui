...
import { appTools, getAppType, toolLabelDisplays, toolLabels, tools } from 'src/pages/workspaces/workspace/analysis/utils/tool-utils'
...
export const ContextBar = ({
  ...
  const getTotalToolAndDiskCostDisplay = () => {
    ...
    return !isGoogleWorkspace(workspace) && currentRuntime && currentRuntime.status === 'Stopped' ? '$0.00' : `${display}` //[IA-4105] TODO: add azure cost calculation
  }
