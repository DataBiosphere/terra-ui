  ...
  class WorkflowView extends Component {
    ...
    describeSelectionModel() {
      const {
        ...
        entitySelectionModel: { newSetName, selectedEntities, type, willCreateSet },
      } = this.state;
      ...
      return Utils.cond(
        ...
        [type === chooseRootType, () => `${count} selected ${rootEntityType}${pluralS} ${willCreateSet ? newSetMessage(setType) : ''}`],
