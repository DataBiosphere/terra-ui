        ...
        deleting &&
          h(DeleteWorkflowConfirmationModal, {
            ...
            onConfirm: async () => {
              ...
              try {
                await Ajax().Workspaces.workspace(workspace.namespace, workspace.name).methodConfig(savedConfig.namespace, savedConfig.name).delete();
...
WorkflowViewComponent.propTypes = {
