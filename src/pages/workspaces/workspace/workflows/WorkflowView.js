                      ...
                      div({ style: { display: 'flex', flexDirection: 'column', marginLeft: '2.0rem', width: '20rem', key: 'textFieldsParent' } }, [
                        div({ style: { display: 'flex', flexDirection: 'row', alignItems: 'center' } }, [
                          h(TextInput, {
                            ...
                            onChange: (v) => this.setState({ monitoringScript: v || undefined }),
                        ...
                        div({ style: { display: 'flex', flexDirection: 'row', alignItems: 'center' } }, [
                          h(TextInput, {
                            ...
                            onChange: (v) => this.setState({ monitoringImage: v || undefined }),
                            style: { marginTop: '0.5rem', width: '90%', marginRight: '0.5rem' },
                          }),
                        ...
                        div({ style: { display: 'flex', flexDirection: 'row', alignItems: 'center' } }, [
                          h(TextInput, {
                            ...
                            onChange: (v) => this.setState({ monitoringImageScript: v || undefined }),
                            style: { marginTop: '0.5rem', width: '90%', marginRight: '0.5rem' },
                          }),
