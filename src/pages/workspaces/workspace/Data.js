  ...
  return div({ style: styles.tableContainer }, [
    !entityMetadata ? spinnerOverlay : h(Fragment, [
      ...
      div({ style: styles.tableViewPanel }, [
        ...
        Utils.cond(
          [createdBy === getUser()?.email || isGoogleWorkspace, () => Utils.switchCase(selectedData?.type,
            [undefined, () => Utils.cond(
              [isAzureWorkspace && !wdsReady, () => div({ style: { textAlign: 'center', lineHeight: '1.4rem', marginTop: '1rem', marginLeft: '5rem', marginRight: '5rem' } },
                [icon('loadingSpinner'),
