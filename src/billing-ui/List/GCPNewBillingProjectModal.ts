...
import CreateGCPBillingProject from 'src/billing-ui/CreateGCPBillingProject';
    ...
    [
      ...
      billingPresent &&
        h(Fragment, [
          ...
          !!chosenBillingAccount &&
            !chosenBillingAccount.firecloudHasAccess &&
            div({ style: { fontWeight: 500, fontSize: 13 } }, [
              ...
              div({ style: { marginBottom: '0.25rem' } }, [
                ...
                ' as a ',
                span({ style: { fontWeight: 'bold' } }, ['Billing Account User']),
                ' on the ',
                h(
                  Link,
                  {
              ...
              div({ style: { marginBottom: '0.25rem' } }, [
                'Then, ',
                h(Link, { onClick: props.loadAccounts }, ['click here']),
                ' to refresh your billing accounts.',
              ]),
