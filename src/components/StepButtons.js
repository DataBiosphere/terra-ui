...
const styles = {
  ...
  button: isActive => ({
    ...
    borderColor: isActive ? colors.primary(1.2) : colors.dark(0.55),
...
const els = {
  dot: isActive => div({
    style: {
      ...
      backgroundColor: isActive ? colors.primary(1.2) : colors.dark(0.55)
    }
  }),
  selectionUnderline: div({
    style: {
      margin: '8px auto 0', width: params.buttonWidth - params.buttonHeight,
      border: `4px solid ${colors.primary(1.2)}`, borderRadius: 4
    }
  })
}
