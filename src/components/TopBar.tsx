...
export const TopBar = (props: TopBarProps): ReactNode => {
      ...
      >
        ...
        <div style={navContainerStyles(transitionState)} onClick={(e) => e.stopPropagation()}>
          <div role='list' style={{ display: 'flex', flexDirection: 'column', overflowY: 'auto', flex: 1 }}>
            ...
            >
              <DropDownSubItem
                href='https://support.terra.bio/hc/en-us/sections/4408259082139-Quickstart-tutorials'
                onClick={hideNav}
                {...Utils.newTabLinkProps}
              >
                Quickstart Guide
  ...
  // Data Science Services' sidebar is significantly different from the sidebar used by every other
