...
describe('getDownloadCommand', () => {
  it('gets download command for gsutil', () => {
    expect(getDownloadCommand({ fileName: 'test.txt', uri: 'gs://demo-data/test.txt' })).toBe('gsutil cp gs://demo-data/test.txt test.txt')
  })

  it('gets download command for azcopy', () => {
    expect(getDownloadCommand({ fileName: 'test.txt', uri: 'https://lz8a3d793f17ede9b79635cc.blob.core.windows.net/sc-4b638f1f-b0a3-4161-a3fa-70e48edd981d/test.txt' })).toBe("azcopy 'https://lz8a3d793f17ede9b79635cc.blob.core.windows.net/sc-4b638f1f-b0a3-4161-a3fa-70e48edd981d/test.txt' test.txt")
  })
})
