...
const EntitiesContent = ({
  ...
  entityKey, filterTerms, entityMetadata, setEntityMetadata, loadMetadata, firstRender, snapshotName, deleteColumnUpdateMetadata
}) => {
  // State
  ...
  return igvFiles ?
    ...
    h(Fragment, [
      h(DataTable, {
        ...
        entityType: entityKey, filterTerms, entityMetadata, setEntityMetadata, columnDefaults, googleProject, workspaceId: { namespace, name }, workspace,
