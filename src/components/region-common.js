...
import { defaultComputeRegion } from 'src/analysis/utils/runtime-utils';
...
// For current phased release of regionality only supporting US-CENTRAL1 buckets.
const supportedBucketLocations = ['US-CENTRAL1'];
