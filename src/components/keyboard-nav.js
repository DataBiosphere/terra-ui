...
/**
 * Sets up a collection of children to support navigation with the arrow keys as well as home/end.
 ...
 */
export const withArrowKeyNavigation = children => {
  ...
  return _.map(([i, child]) => {
    return child({ forwardedRef: refs[i], onKeyDown: onKeyDown(i) })
