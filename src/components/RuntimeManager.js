...
import { appIsSettingUp, collapsedRuntimeStatus, convertedAppStatus, currentApp, currentRuntime, persistentDiskCost, runtimeCost, trimRuntimesOldestFirst } from 'src/libs/runtime-utils'
      ...
      app && div({ style: { ...styles.container, borderRadius: 5, marginRight: '1.5rem' } }, [
        h(Clickable, {
          ...
          div([
            ...
            div({ style: { fontSize: 10 } }, [_.capitalize(convertedAppStatus(app.status))])
          ])
        ])
      ]),
