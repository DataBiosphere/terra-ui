...
const ClusterIcon = ({ shape, onClick, disabled, style, ...props }) => {
  return h(Clickable, {
    style: { color: onClick && !disabled ? colors.primary() : colors.dark(0.7), ...style },
    ...
    return div({ style: styles.container }, [
      ...
      h(PopupTrigger, {
        ...
        h(Clickable, {
          ...
          icon('cog', { size: 22, className: 'is-solid', style: { color: isDisabled ? colors.dark(0.7) : colors.primary() } })
        ])
      ]),
      deleting && h(Modal, {
