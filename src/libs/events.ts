...
const eventsList = {
  ...
  teaspoons: {
    ...
    viewPurchaseQuotaOptionsClick: 'teaspoons:quotas:viewPurchaseQuotaOptionsClick',
    ...
    continuePurchaseFromMarketingPage: 'teaspoons:continuePurchaseFromMarketingPage',
  },
