...
const eventsList = {
  ...
  teaspoons: {
    ...
    purchaseQuotaClick: 'teaspoons:quotas:purchaseQuotaClick',
    getQuoteCardClick: 'teaspoons:quotas:getQuoteCardClick',
    selfServiceCardClick: 'teaspoons:quotas:selfServiceCardClick',
    payWithCardClick: 'teaspoons:quotas:payWithCardClick',
  },
  ...
  workspaceCreateSharing: 'workspace:creation:sharingTab',
  workspaceCreateSecurity: 'workspace:creation:securityTab',
