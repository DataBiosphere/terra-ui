...
export const useTermsOfServiceAlerts = () => {
  useEffect(() => {
    return authStore.subscribe(authState => getTermsOfServiceAlerts(authState)
      .then(tosGracePeriodAlerts => tosGracePeriodAlertsStore.set(tosGracePeriodAlerts), _.noop))
      .unsubscribe
  }, [])
