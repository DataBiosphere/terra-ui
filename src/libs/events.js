...
const eventsList = {
  ...
  workspaceDataFilterByName: 'workspace:data:filterbyname',
  workspaceDataFilterByColumn: 'workspace:data:filterbycolumn',
  workspaceDataFullTableSearch: 'workspace:data:fulltablesearch',
