...
const eventsList = {
  ...
  userAuthTokenReloadSuccess: 'user:authTokenReloadSuccess',
  userAuthTokenReloadExpired: 'user:authTokenReloadExpiredRefreshToken',
  userAuthTokenReloadError: 'user:authTokenReloadError',
