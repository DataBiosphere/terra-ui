...
const eventsList = {
  ...
  billingAzureCreationUsersAdded: 'billing:creation:step2:AzureUsersSpecified',
  billingAzureCreationOwnersAdded: 'billing:creation:step2:AzureOwnersSpecified',
  billingAzureCreationProjectNameEntered: 'billing:creation:step3:AzureBillingProjectNameEntered',
  billingAzureCreationProjectDuplicateName: 'billing:creation:step3:AzureBillingProjectDuplicateName',
