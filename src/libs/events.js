...
const eventsList = {
  ...
  billingCreationStep3VerifyUserAdded: 'billing:creation:step3:verifyUserAdded',
  billingCreationStep3BillingAccountNoAccess: 'billing:creation:step3:billingAccountNoAccess',
  billingCreationStep3AddedTerraBilling: 'billing:creation:step3:addedTerraBilling',
  billingCreationRefreshStep3: 'billing:creation:refreshStep3',
