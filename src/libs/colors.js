...
const colorPalette = Utils.cond(
  ...
  // [isRadX(), () => ({ ...baseColors, primary: '#4a66ac', secondary: '#7f8fA9', dark: '#243d7e', accent: '#4a66ac', light: '#accbf9' })],
  [isRadX(), () => ({ ...baseColors, primary: '#4a66ac', secondary: '#7f8fA9', dark: '#243d7e', accent: '#297fd5', light: '#accbf9' })],
