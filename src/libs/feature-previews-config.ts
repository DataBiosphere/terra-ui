...
export const DEPRECATE_FIRECLOUD_UI = 'deprecateFirecloudUI';
...
const featurePreviewsConfig: readonly FeaturePreview[] = [
  ...
  {
    id: DEPRECATE_FIRECLOUD_UI,
    title: 'Deprecate Firecloud UI',
    description: 'Enabling this feature will update any replaceable links to Firecloud UI with new links to Terra UI',
