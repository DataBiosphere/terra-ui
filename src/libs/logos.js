...
export const terraLogoMaker = (logoVariant, style) => img({ alt: 'Terra logo', src: logoVariant, style })

const brandLogoMaker = (size, color = false) => img({ alt: `${getAppName()} logo`, src: pickBrandLogo(color), style: { height: size, marginRight: '1.5rem' } })
