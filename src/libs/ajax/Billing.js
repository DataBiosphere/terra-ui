...
import { authOpts, checkRequesterPaysError, fetchBillingProfileManager, fetchOrchestration, fetchRawls, jsonBody } from 'src/libs/ajax/ajax-common'
 ...
 */
export const withRequesterPays = wrappedFetch => (url, ...args) => {
