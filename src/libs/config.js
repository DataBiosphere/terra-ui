...
export const brands = {
  ...
  bioDataCatalyst: {
    ...
    cookieName: 'NHLBI BioData Catalyst',
  ...
  rareX: {
    ...
    cookieName: 'The RARE‑X Data Analysis Platform',
