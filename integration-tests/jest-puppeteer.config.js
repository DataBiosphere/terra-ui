module.exports = {
  ...
  launch: {
    ...
    // TODO: the below code explicitly allows third-party cookies in the Chrome used for integration tests.
    //    This is necessary to allow the `run-rstudio` and `run-analysis` tests to pass, which require 3p cookies.
    //    When Terra no longer requires third-party cookies, remove this exception.
