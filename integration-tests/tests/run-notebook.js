...
const testRunNotebookFn = _.flow(
  ...
  await findElement(page, '//*[./label[contains(text(),\'CPUs\')]]/div[1]//div[@role=\'combobox\' and @aria-expanded=\'false\']')
  await click(page, '//*[./label[contains(text(),\'CPUs\')]]/div[1]//div[@role=\'combobox\' and @aria-expanded=\'false\']')
  await findElement(page,'//*[./label[contains(text(),\'CPUs\')]]/div[1]//div[@role=\'combobox\' and @aria-expanded=\'true\']/*[@role="listbox"]')
  await click(page, '//*[./label[contains(text(),\'CPUs\')]]/div[1]//div[@role=\'combobox\' and @aria-expanded=\'true\']//div[@role=\'listbox\']//div[contains(text(),\'4\')]')
  await findElement(page, '//*[./label[contains(text(),\'CPUs\')]]/div[1]//div[@role=\'combobox\' and @aria-expanded=\'false\']')
