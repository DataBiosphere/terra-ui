...
const npmCorrect = npmVersion.startsWith('6.10.')
...
if (!npmCorrect || !nodeCorrect) {
  ...
  if (nodeCorrect) {
    console.error(`║ Must have npm 6.10, you have ${npmVersion}. To fix:`.padEnd(80) + '║')
    console.error('║ $ npm install -g npm@6.10'.padEnd(80) + '║')
  } else {
