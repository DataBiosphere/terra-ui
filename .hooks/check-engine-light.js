...
const npmCorrect = npmVersion.startsWith('6.12.')
...
if (!npmCorrect || !nodeCorrect) {
  ...
  if (nodeCorrect) {
    console.error(`║ Must have npm 6.12, you have ${npmVersion}. To fix:`.padEnd(80) + '║')
    console.error('║ $ npm install -g npm@6.12'.padEnd(80) + '║')
  } else {
