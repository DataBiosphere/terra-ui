...
declare module "react-hyperscript-helpers" {
  ...
  type HtmlHelper<T extends TagName> = {
    (props: Omit<WithDataAttributes<HTMLElementProps<T>>, "children">, children: React.ReactNode[]): React.ReactElement<
      any,
      any
    >;

    (propsOrChildren?: WithDataAttributes<HTMLElementProps<T>> | React.ReactNode[]): React.ReactElement<any, any>;
  };
